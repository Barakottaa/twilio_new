...
function showHelp() {
  console.log(`
🚀 Bird PDF Media Sender

📋 Usage:
   node send-pdf-media.js --phone=+1234567890 [options]
...
📋 Examples:
   # Send all PDFs from default folder
   node send-pdf-media.js --phone=+201016666348

   # Send all PDFs from custom folder
   node send-pdf-media.js --phone=+201016666348 --folder=C:\\MyPDFs

   # Send single PDF file
   node send-pdf-media.js --phone=+201016666348 --file=report.pdf

   # Send with custom content type
   node send-pdf-media.js --phone=+201016666348 --content-type=application/pdf
`);
}
...
// Step 3: Send WhatsApp message with media
...
// Main function
async function main() {
  console.log('🚀 Bird PDF Media Sender\n');
